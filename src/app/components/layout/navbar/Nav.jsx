      ...
      <nav>
        ...
        <div
          className={`border-b border-white/10 ${
            scrolling
              ? "border-brand-dark/20 -mt-[2.7631rem] xl:-mt-[48.7296px] 3xl:-mt-[60.8096px] bg-white text-brand-dark"
              : "text-white mt-0"
          } transition-all duration-300 py-3 sm:py-4 3xl:py-6`}
        >
          <div className="container flex items-center justify-between">
            <LogoAndNavLinks scrolling={scrolling} />
            ...
            <div className="flex items-center gap-3.5">
              ...
              >
                ...
                <svg
                  ...
                  className={` ${
                    scrolling
                      ? "fill-brand-dark/80 group-hover:fill-brand-dark/50"
